...
class RootViewController: UITabBarController {
    ...
    let articleListingCoordinator = AllArticlesListCoordinator(navigationController: UINavigationController())
...
//        viewControllers = [articleListingCoordinator.navigationController]
